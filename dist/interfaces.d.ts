...
export interface ConstructorOptions {
    /**Прокси для запроса по умолчанию. Должен быть представлен в следующем формате: http://username:password@login:password */
    proxy?: string;
    /**Это свойство User-Agent, которое будет в headers каждого запроса */
    userAgent?: string;
    /**Время, дольше которого запрос не будет выполняться (в милисекундах) */
    timeout?: number;
    /**Значение заголовков запроса по умолчанию */
